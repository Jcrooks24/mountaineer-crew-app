...
be limited to long-distance jobs and/or to specific job types.
...
def default_items() -> List[Dict[str, Any]]:
    ...
    return [
        {"key": "pretrip_dvir", "label": "Pre-trip DVIR submitted", "auto_key": "pretrip_dvir", "ld_only": False, "job_types": []},
        {"key": "posttrip_dvir", "label": "Post-trip DVIR submitted", "auto_key": "posttrip_dvir", "ld_only": False, "job_types": []},
        {"key": "trucks_swept", "label": "Trucks swept out", "auto_key": "", "ld_only": False, "job_types": []},
        {"key": "gear_accounted", "label": "Company gear accounted for (4-wheel dolly, 2-wheel dolly, tool bag, straps, all blankets, consumables)", "auto_key": "", "ld_only": False, "job_types": []},
        {"key": "incidents_reported", "label": "Incidents reported (if any)", "auto_key": "", "ld_only": False, "job_types": []},
        {"key": "job_report", "label": "Job report completed", "auto_key": "job_report", "ld_only": False, "job_types": []},
        {"key": "bol_origin", "label": "BOL signed at origin", "auto_key": "bol_origin_signed", "ld_only": True, "job_types": []},
        {"key": "inventory", "label": "Complete item inventory", "auto_key": "inventory", "ld_only": True, "job_types": []},
        {"key": "weighed", "label": "Weighed at a certified scale", "auto_key": "weighed", "ld_only": True, "job_types": []},
        {"key": "bol_dest", "label": "BOL signed at destination", "auto_key": "bol_delivered", "ld_only": True, "job_types": []},
        {"key": "pods", "label": "PODS completed (1 per driver per trip)", "auto_key": "pods", "ld_only": True, "job_types": []},
        {"key": "rods", "label": "RODS completed (1 per drive-day per driver)", "auto_key": "rods", "ld_only": True, "job_types": []},
        {"key": "dot_markings", "label": "DOT number, company name, and MC number displayed on truck", "auto_key": "", "ld_only": True, "job_types": []},
    ]
