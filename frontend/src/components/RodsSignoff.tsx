...
/**
 * Driver RODS sign-off, shown on the Report tab. The day's duty status is
 * recorded on the Timeline (RodsRecorder); here the DRIVER reviews the totals,
 * fills the trip details, and signs. Self-hides when there's no RODS to sign
 * (no duty changes logged today), so non-driving crew don't see it.
 */
export default function RodsSignoff() {
  ...
  // Nothing to sign (no driving logged today) — hide for non-drivers.
  ...
  return (
    <div className="card" style={{ borderColor: "var(--brand)" }}>
      ...
      <div className="small" style={{ color: "var(--muted)", marginBottom: 10, lineHeight: 1.5 }}>
        For the person who <strong>drove</strong> today. Review the totals, add trip details, and sign.
