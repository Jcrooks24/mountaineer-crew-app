...
Origin Signing (before loading): capture the actual pickup date and the vehicle (unit) for this trip, the client's printed name, both signatures, and check the electronic-signature consent box. Tap "Sign at origin & give copy."
